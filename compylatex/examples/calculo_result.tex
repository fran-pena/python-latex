...
La ra\'{\i}z aproximada de 
\begin{equation} % para comprobar que no se modifica
    f(x) = x^3 - 2
    \label{ecraices}
\end{equation} obtenida por Newton-Raphson es:
...
El m\'etodo de Euler expl\'{\i}cito aproxima la soluci\'on de un problema de valor inicial $y' = f(t, y)$, $y(t_0) = y_0$, mediante la iteraci\'on:
\begin{equation}
